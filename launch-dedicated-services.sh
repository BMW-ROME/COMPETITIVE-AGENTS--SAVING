...
docker stop competitive-trading-postgres competitive-trading-redis 2>/dev/null
docker rm competitive-trading-postgres competitive-trading-redis 2>/dev/null

echo ""
echo "Creating network if it doesn't exist..."
docker network create competitive-trading-network 2>/dev/null
